---
title: Hasura
description: A Hasura v2 instance with a PostgreSQL database
tags:
  - postgresql
  - hasura
---
...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new?template=https://github.com/devwax/railway-starter-hasura-v2&plugins=postgresql&envs=HASURA_GRAPHQL_ADMIN_SECRET&HASURA_GRAPHQL_ADMIN_SECRETDesc=To+secure+your+GraphQL+endpoint+and+the+Hasura+console.)
